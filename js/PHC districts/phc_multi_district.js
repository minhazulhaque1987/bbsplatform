...
function renderPHCDistrictSelector() {
  ...
  // ৬৪ জেলার meta (আপনার দেওয়া সাজেশন)
  const districtsData = [
    { nameBn: "বরগুনা", nameEn: "Barguna", division: "বরিশাল বিভাগ", upazilaCount: 6, icon: "🌾", color: "#2E7D32" },
    { nameBn: "বরিশাল", nameEn: "Barishal", division: "বরিশাল বিভাগ", upazilaCount: 10, icon: "🚢", color: "#2E7D32" },
    { nameBn: "ভোলা", nameEn: "Bhola", division: "বরিশাল বিভাগ", upazilaCount: 7, icon: "🏝️", color: "#2E7D32" },
    { nameBn: "ঝালকাঠি", nameEn: "Jhalokathi", division: "বরিশাল বিভাগ", upazilaCount: 4, icon: "🎣", color: "#2E7D32" },
    { nameBn: "পটুয়াখালী", nameEn: "Patuakhali", division: "বরিশাল বিভাগ", upazilaCount: 8, icon: "🐟", color: "#2E7D32" },
    { nameBn: "পিরোজপুর", nameEn: "Pirojpur", division: "বরিশাল বিভাগ", upazilaCount: 7, icon: "🥥", color: "#2E7D32" },

    { nameBn: "বান্দরবান", nameEn: "Bandarban", division: "চট্টগ্রাম বিভাগ", upazilaCount: 7, icon: "⛰️", color: "#1565C0" },
    { nameBn: "ব্রাহ্মণবাড়িয়া", nameEn: "Brahmanbaria", division: "চট্টগ্রাম বিভাগ", upazilaCount: 9, icon: "🕌", color: "#1565C0" },
    { nameBn: "চাঁদপুর", nameEn: "Chandpur", division: "চট্টগ্রাম বিভাগ", upazilaCount: 8, icon: "🌊", color: "#1565C0" },
    { nameBn: "চট্টগ্রাম", nameEn: "Chattogram", division: "চট্টগ্রাম বিভাগ", upazilaCount: 15, icon: "🏭", color: "#1565C0" },
    { nameBn: "কক্সবাজার", nameEn: "Cox's Bazar", division: "চট্টগ্রাম বিভাগ", upazilaCount: 9, icon: "🏖️", color: "#1565C0" },
    { nameBn: "কুমিল্লা", nameEn: "Comilla", division: "চট্টগ্রাম বিভাগ", upazilaCount: 17, icon: "📿", color: "#1565C0" },
    { nameBn: "ফেনী", nameEn: "Feni", division: "চট্টগ্রাম বিভাগ", upazilaCount: 6, icon: "🍍", color: "#1565C0" },
    { nameBn: "খাগড়াছড়ি", nameEn: "Khagrachhari", division: "চট্টগ্রাম বিভাগ", upazilaCount: 9, icon: "🌄", color: "#1565C0" },
    { nameBn: "লক্ষ্মীপুর", nameEn: "Lakshmipur", division: "চট্টগ্রাম বিভাগ", upazilaCount: 5, icon: "🌾", color: "#1565C0" },
    { nameBn: "নোয়াখালী", nameEn: "Noakhali", division: "চট্টগ্রাম বিভাগ", upazilaCount: 9, icon: "🐚", color: "#1565C0" },
    { nameBn: "রাঙ্গামাটি", nameEn: "Rangamati", division: "চট্টগ্রাম বিভাগ", upazilaCount: 10, icon: "💧", color: "#1565C0" },

    { nameBn: "ঢাকা", nameEn: "Dhaka", division: "ঢাকা বিভাগ", upazilaCount: 5, icon: "🏛️", color: "#FF8F00" },
    { nameBn: "ফরিদপুর", nameEn: "Faridpur", division: "ঢাকা বিভাগ", upazilaCount: 9, icon: "🍉", color: "#FF8F00" },
    { nameBn: "গাজীপুর", nameEn: "Gazipur", division: "ঢাকা বিভাগ", upazilaCount: 5, icon: "🏭", color: "#FF8F00" },
    { nameBn: "গোপালগঞ্জ", nameEn: "Gopalganj", division: "ঢাকা বিভাগ", upazilaCount: 5, icon: "🏞️", color: "#FF8F00" },
    { nameBn: "কিশোরগঞ্জ", nameEn: "Kishoreganj", division: "ঢাকা বিভাগ", upazilaCount: 13, icon: "🎋", color: "#FF8F00" },
    { nameBn: "মাদারীপুর", nameEn: "Madaripur", division: "ঢাকা বিভাগ", upazilaCount: 4, icon: "⛵", color: "#FF8F00" },
    { nameBn: "মানিকগঞ্জ", nameEn: "Manikganj", division: "ঢাকা বিভাগ", upazilaCount: 7, icon: "🌿", color: "#FF8F00" },
    { nameBn: "মুন্সীগঞ্জ", nameEn: "Munshiganj", division: "ঢাকা বিভাগ", upazilaCount: 6, icon: "⛪", color: "#FF8F00" },
    { nameBn: "নারায়ণগঞ্জ", nameEn: "Narayanganj", division: "ঢাকা বিভাগ", upazilaCount: 5, icon: "⚓", color: "#FF8F00" },
    { nameBn: "নরসিংদী", nameEn: "Narsingdi", division: "ঢাকা বিভাগ", upazilaCount: 6, icon: "🧵", color: "#FF8F00" },
    { nameBn: "রাজবাড়ী", nameEn: "Rajbari", division: "ঢাকা বিভাগ", upazilaCount: 5, icon: "🌾", color: "#FF8F00" },
    { nameBn: "শরীয়তপুর", nameEn: "Shariatpur", division: "ঢাকা বিভাগ", upazilaCount: 6, icon: "🏞️", color: "#FF8F00" },
    { nameBn: "টাঙ্গাইল", nameEn: "Tangail", division: "ঢাকা বিভাগ", upazilaCount: 12, icon: "🍚", color: "#FF8F00" },

    { nameBn: "বাগেরহাট", nameEn: "Bagerhat", division: "খুলনা বিভাগ", upazilaCount: 9, icon: "🕌", color: "#AD1457" },
    { nameBn: "চুয়াডাঙ্গা", nameEn: "Chuadanga", division: "খুলনা বিভাগ", upazilaCount: 4, icon: "🌽", color: "#AD1457" },
    { nameBn: "যশোর", nameEn: "Jashore", division: "খুলনা বিভাগ", upazilaCount: 8, icon: "🍬", color: "#AD1457" },
    { nameBn: "ঝিনাইদহ", nameEn: "Jhenaidah", division: "খুলনা বিভাগ", upazilaCount: 6, icon: "🌻", color: "#AD1457" },
    { nameBn: "খুলনা", nameEn: "Khulna", division: "খুলনা বিভাগ", upazilaCount: 9, icon: "🌊", color: "#AD1457" },
    { nameBn: "কুষ্টিয়া", nameEn: "Kushtia", division: "খুলনা বিভাগ", upazilaCount: 6, icon: "🎭", color: "#AD1457" },
    { nameBn: "মাগুরা", nameEn: "Magura", division: "খুলনা বিভাগ", upazilaCount: 4, icon: "🌾", color: "#AD1457" },
    { nameBn: "মেহেরপুর", nameEn: "Meherpur", division: "খুলনা বিভাগ", upazilaCount: 3, icon: "🌳", color: "#AD1457" },
    { nameBn: "নড়াইল", nameEn: "Narail", division: "খুলনা বিভাগ", upazilaCount: 3, icon: "🎣", color: "#AD1457" },
    { nameBn: "সাতক্ষীরা", nameEn: "Satkhira", division: "খুলনা বিভাগ", upazilaCount: 7, icon: "🌊", color: "#AD1457" },

    { nameBn: "জামালপুর", nameEn: "Jamalpur", division: "ময়মনসিংহ বিভাগ", upazilaCount: 7, icon: "🌾", color: "#00695C" },
    { nameBn: "ময়মনসিংহ", nameEn: "Mymensingh", division: "ময়মনসিংহ বিভাগ", upazilaCount: 12, icon: "🏞️", color: "#00695C" },
    { nameBn: "নেত্রকোণা", nameEn: "Netrokona", division: "ময়মনসিংহ বিভাগ", upazilaCount: 10, icon: "🌳", color: "#00695C" },
    { nameBn: "শেরপুর", nameEn: "Sherpur", division: "ময়মনসিংহ বিভাগ", upazilaCount: 5, icon: "🍊", color: "#00695C" },

    { nameBn: "বগুড়া", nameEn: "Bogra", division: "রাজশাহী বিভাগ", upazilaCount: 12, icon: "🍞", color: "#BF360C" },
    { nameBn: "জয়পুরহাট", nameEn: "Joypurhat", division: "রাজশাহী বিভাগ", upazilaCount: 5, icon: "🌾", color: "#BF360C" },
    { nameBn: "নওগাঁ", nameEn: "Naogaon", division: "রাজশাহী বিভাগ", upazilaCount: 11, icon: "🥭", color: "#BF360C" },
    { nameBn: "নাটোর", nameEn: "Natore", division: "রাজশাহী বিভাগ", upazilaCount: 7, icon: "🏛️", color: "#BF360C" },
    { nameBn: "চাঁপাইনবাবগঞ্জ", nameEn: "Chapainawabganj", division: "রাজশাহী বিভাগ", upazilaCount: 5, icon: "🍑", color: "#BF360C" },
    { nameBn: "পাবনা", nameEn: "Pabna", division: "রাজশাহী বিভাগ", upazilaCount: 9, icon: "🧣", color: "#BF360C" },
    { nameBn: "রাজশাহী", nameEn: "Rajshahi", division: "রাজশাহী বিভাগ", upazilaCount: 9, icon: "🍉", color: "#BF360C" },
    { nameBn: "সিরাজগঞ্জ", nameEn: "Sirajganj", division: "রাজশাহী বিভাগ", upazilaCount: 9, icon: "🌾", color: "#BF360C" },

    { nameBn: "দিনাজপুর", nameEn: "Dinajpur", division: "রংপুর বিভাগ", upazilaCount: 13, icon: "🍚", color: "#6A1B9A" },
    { nameBn: "গাইবান্ধা", nameEn: "Gaibandha", division: "রংপুর বিভাগ", upazilaCount: 7, icon: "🌊", color: "#6A1B9A" },
    { nameBn: "কুড়িগ্রাম", nameEn: "Kurigram", division: "রংপুর বিভাগ", upazilaCount: 9, icon: "🏞️", color: "#6A1B9A" },
    { nameBn: "লালমনিরহাট", nameEn: "Lalmonirhat", division: "রংপুর বিভাগ", upazilaCount: 5, icon: "🍃", color: "#6A1B9A" },
    { nameBn: "নীলফামারী", nameEn: "Nilphamari", division: "রংপুর বিভাগ", upazilaCount: 6, icon: "🌾", color: "#6A1B9A" },
    { nameBn: "পঞ্চগড়", nameEn: "Panchagarh", division: "রংপুর বিভাগ", upazilaCount: 5, icon: "⛰️", color: "#6A1B9A" },
    { nameBn: "রংপুর", nameEn: "Rangpur", division: "রংপুর বিভাগ", upazilaCount: 8, icon: "🚜", color: "#6A1B9A" },
    { nameBn: "ঠাকুরগাঁও", nameEn: "Thakurgaon", division: "রংপুর বিভাগ", upazilaCount: 5, icon: "🌽", color: "#6A1B9A" },

    { nameBn: "হবিগঞ্জ", nameEn: "Habiganj", division: "সিলেট বিভাগ", upazilaCount: 8, icon: "🌿", color: "#0D47A1" },
    { nameBn: "মৌলভীবাজার", nameEn: "Moulvibazar", division: "সিলেট বিভাগ", upazilaCount: 7, icon: "🍃", color: "#0D47A1" },
    { nameBn: "সুনামগঞ্জ", nameEn: "Sunamganj", division: "সিলেট বিভাগ", upazilaCount: 11, icon: "💧", color: "#0D47A1" },
    { nameBn: "সিলেট", nameEn: "Sylhet", division: "সিলেট বিভাগ", upazilaCount: 13, icon: "🍵", color: "#0D47A1" },
  ];

  const metaByEn = {};
  districtsData.forEach(x => { metaByEn[x.nameEn.toLowerCase()] = x; });

  function baseId(id) {
    return (id || '').replace('_comm', '');
  }

  function pickMeta(regEntry) {
    const en = (regEntry && regEntry.name_en) ? String(regEntry.name_en).toLowerCase() : '';
    return metaByEn[en] || null;
  }
  ...
  const availableEntries = registry.filter(d => d.available);
  const comingEntries = registry.filter(d => !d.available);

  // Merge district+community into one district card (base id)
  const merged = {};
  for (const entry of availableEntries) {
    const b = baseId(entry.id);
    if (!merged[b]) {
      merged[b] = {
        base: b,
        districtEntry: null,
    ...
    const isCommunity = (entry.series || entry.report_type) === 'community' || String(entry.id || '').endsWith('_comm');
    if (isCommunity) merged[b].communityEntry = entry;
    else merged[b].districtEntry = entry;
  }

  // ৬৪ জেলারই কার্ড দেখাতে হবে: base id list বানাবো
  const baseDistrictIds = districtsData.map(x => {
    // match base registry id by English name when possible
    const en = x.nameEn;
    // Try to find any available registry entry whose name_en matches
    const found = availableEntries.find(e => e.name_en === en);
    if (found) return baseId(found.id);
    // fallback: manual mapping for the few cases that exist in current PHC registry
    // (since not all 64 are present in PHC_ALL_DISTRICTS yet)
    const bnMap = {
      'ঢাকা': 'dhaka',
      'নারায়ণগঞ্জ': 'narsingdi',
    };
    return null;
  }).filter(Boolean);

  // If current dataset doesn't contain mapping for all 64 yet,
  // create a stable 64-card list by using the base ids found in registry for now.
  // (UI requirement: show 64 cards; when click and no data -> show coming message.)
  const allDistrictCards = districtsData.map(meta => {
    // Find corresponding merged entry by name_en match
    const targetEn = meta.nameEn;
    const mergedEntry = Object.values(merged).find(m => {
      const n = ((m.districtEntry || m.communityEntry || {}).name_en || '');
      return n === targetEn;
    }) || null;

    const hasCommunity = mergedEntry ? !!mergedEntry.communityEntry : false;
    const hasDistrict = mergedEntry ? !!mergedEntry.districtEntry : false;
    const hasAny = hasCommunity || hasDistrict;

    const base = mergedEntry ? mergedEntry.base : null;
    const tagsHtml = `
      <div style="display:flex;flex-wrap:wrap;gap:6px;margin-top:6px;">
        ${hasCommunity ? `<span class="phc-dsc-tag" style="background:${meta.color}20;color:${meta.color}">কমিউনিটি রিপোর্ট</span>` : ''}
        ${hasDistrict ? `<span class="phc-dsc-tag" style="background:${meta.color}20;color:${meta.color}">জেলা রিপোর্ট</span>` : ''}
      </div>`;

    const badgeText = hasAny ? '✓ ডাটা আছে' : 'শীঘ্রই';
    const badgeStyle = hasAny ? `background:${meta.color}` : '';

    return `
      <div class="phc-dist-sel-card" ${hasAny ? `onclick="loadPHCDistrict('${base}')"` : `onclick="toastComingDistrict('${meta.nameEn}')"`}
        style="border-left:4px solid ${meta.color} ${hasAny ? '' : 'opacity:0.75'}">
        <div class="phc-dsc-top">
          <span class="phc-dsc-icon">${meta.icon}</span>
          <div>
            <div class="phc-dsc-name">${meta.nameBn}</div>
            <div class="phc-dsc-en">${meta.nameEn}</div>
          </div>
          <span class="phc-dsc-badge" style="${badgeStyle}">${badgeText}</span>
        </div>
        <div class="phc-dsc-stats">
          <span>🗺️ ${meta.division} বিভাগ</span>
          <span>🏛️ ${meta.upazilaCount} উপজেলা</span>
          ${tagsHtml}
        </div>
      </div>`;
  }).join('');

  // বিভাগ ভিত্তিক সাজানো (চট্টগ্রাম -> ঢাকা -> বরিশাল -> খুলনা -> রাজশাহী -> রংপুর -> ময়মনসিংহ -> সিলেট)
  const DIV_ORDER = {
    "চট্টগ্রাম": 0,
    "ঢাকা": 1,
    "বরিশাল": 2,
  ...
  function getDivKey(divisionStr){
    const s = divisionStr || '';
    // divisionStr like "চট্টগ্রাম বিভাগ"
    for (const k of Object.keys(DIV_ORDER)) {
      if (s.includes(k)) return DIV_ORDER[k];
    }
    return 999;
  }

  // (allDistrictCards is a string from join, so don't call sort() on it)

  const allDistrictCardsSorted = districtsData
    .filter(meta => meta)
    .slice()
    .sort((a,b)=>{
      const da = getDivKey(a.division);
      const db = getDivKey(b.division);
      if(da !== db) return da - db;
      // within division: alphabetical by nameEn
      return (a.nameEn || '').localeCompare(b.nameEn || '');
    })
    .map(meta => {
      // re-use the card generator by matching the rendered card from allDistrictCards is brittle,
      // so generate again via the same logic (copy from below):
      const targetEn = meta.nameEn;
      const mergedEntry = Object.values(merged).find(m => {
        const n = ((m.districtEntry || m.communityEntry || {}).name_en || '');
        return n === targetEn;
  ...
  const mergedCardsHtml = allDistrictCardsSorted;

  const comingCards = comingEntries.slice(0,8).map(d => `
  ...
  const availableMergedCount = Object.keys(merged).length;
  ...
  content.innerHTML = `
    <div class="phc-sel-banner">
      ...
      <div class="phc-sel-count">
        <span class="phc-sel-chip">${bnInt(availableMergedCount)} টি জেলার ডেটা প্রস্তুত</span>
        <span class="phc-sel-chip-gray">${bnInt(64 - availableMergedCount)} টি শীঘ্রই আসছে</span>
      </div>
    </div>

    <div class="phc-sel-section-title">✅ উপলব্ধ জেলাসমূহ</div>
    <div class="phc-dist-grid">${mergedCardsHtml}</div>
...
function loadScript(src, callback) {
  ...
  script.onerror = function() {
    ...
    if (typeof toast === 'function') {
      toast('ডেটা লোড করতে ব্যর্থ হয়েছে!', 'warn');
    }
  };
...
function toastComingDistrict(districtNameEn){
  // use existing toast if available
  if (typeof toast === 'function') {
    toast('এখনও ' + districtNameEn + ' জেলার পূর্ণ তথ্য আসেনি। সামনে তথ্য আসছে।', 'info');
  } else {
    alert('এখনও ' + districtNameEn + ' জেলার পূর্ণ তথ্য আসেনি। সামনে তথ্য আসছে।');
  }
}
...
function loadPHCDistrict(districtId) {
  ...
  if (typeof PHC_ALL_DISTRICTS !== 'undefined' && PHC_ALL_DISTRICTS.length > 0) {
    ...
    commReg = PHC_ALL_DISTRICTS.find(d => d.id === (districtId + '_comm'));
  }

  if (!reg) {
    reg = PHC_DISTRICT_REGISTRY.find(d => d.id === districtId);
    // district registry does not necessarily keep community data_obj, so just look for district
  }

  // Allow base district card to open even when base registry marks available=false,
  // as long as community/district series is available in PHC_ALL_DISTRICTS.
  if ((!reg || !reg.available) && commReg && commReg.available) {
    reg = commReg;
  }
  ...
  let scriptPath = '';
  if (reg.id === 'coxsbazar') {
    scriptPath = 'js/PHC districts/phc_2022_data.js';
  } else if (reg.id === 'chittagong') {
    scriptPath = 'js/PHC districts/phc_ctg_data.js';
  } else if (reg.id === 'gazipur') {
    scriptPath = 'js/PHC districts/phc_gazipur_comm.js';
  } else if (reg.id === 'manikganj') {
    scriptPath = 'js/PHC districts/phc_manikganj_comm.js';
  } else if (reg.id === 'narsingdi') {
    scriptPath = 'js/PHC districts/phc_narsingdi_comm.js';
  } else {
    scriptPath = 'js/PHC districts/phc_' + reg.id + '.js';
  }
  ...
  function initDistrictData() {
    ...
    // Fallback: many district files define const arrays but do not attach them to window.
    // Try common naming convention: PHC_UPAZILAS_<DISTRICT>_COMM
    if (!phcActiveUpazilas) {
      const dashless = String(reg.id || '').replace(/-/g, '_').toUpperCase();
      const candidates = [
        'PHC_UPAZILAS_' + dashless + '_COMM',
        // some ids might need registry title-casing fix (best-effort)
        'PHC_UPAZILAS_' + dashless.replace(/_COMM$/, '') + '_COMM',
      ];

      for (const k of candidates) {
        if (window[k]) {
          phcActiveUpazilas = window[k];
          break;
        }
      }
    }
    ...
    if (!phcActiveUpazilas) {
      if (typeof toast === 'function') toast('ডেটা লোড হয়নি: ' + (reg.upazilas_obj || 'upazilas_obj'), 'warn');
      return;
    }
  ...
  if (reg.upazilas_obj && window[reg.upazilas_obj]) {
    initDistrictData();
  } else {
    if (typeof toast === 'function') toast('ডেটা লোড হচ্ছে...', 'info');
